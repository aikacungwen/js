// Jumlah episode
var totalEpisodes = 19;
var episodeLinks = [];

// Buat array URL episode secara otomatis
for (var i = 1; i <= totalEpisodes; i++) {
    var episodeUrl = 'https://aikacungwen30.blogspot.com/p/atgms1-' + i + '.html';
...
for (var i = 1; i <= totalEpisodes; i++) {
    ...
    if (currentPageUrl.includes('/atgms1-' + i + '.html')) {
...
var latestEpisodeIndex = 6; // Misalnya episode terbaru adalah index 23 dalam array
